package com.github.mrzhqiang.helper.gbt;
 ...
 * 2260 表示行政区划代码。
 * <p>
 * 2007 表示年份，为当前标准的执行版本。
 */
public final class GBT2260 {
    private GBT2260() {
        // no instances.
    }
    ...
    public static String findLevel(String code) {
        if (Strings.isNullOrEmpty(code) || code.length() != GBT_2260_2007_LENGTH) {
            return "";
        }
