...
public final class Splitters {
     ...
     * 分号分离器。
     */
    public static final Splitter SEMICOLON = Splitter.on(';').trimResults().omitEmptyStrings();
    /**
     * 冒号分离器。
     */
     ...
     * 破折号分离器。
     */
    public static final Splitter DASH = Splitter.on('-').trimResults().omitEmptyStrings();
    /**
     * 点号分离器。
     */
