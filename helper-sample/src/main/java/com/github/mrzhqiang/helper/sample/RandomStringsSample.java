...
import com.github.mrzhqiang.helper.RandomStrings;
...
public class RandomStringsSample extends Application {
    ...
    Label realNameLabel;
    @FXML
    Button generateAccountButton;
    @FXML
    Button generateUserButton;
